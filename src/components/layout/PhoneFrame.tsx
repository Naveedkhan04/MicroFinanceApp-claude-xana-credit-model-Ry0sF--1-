...
export const PhoneFrameOverlayContext = React.createContext<HTMLDivElement | null>(null);
...
export const PhoneFrame: React.FC<Props> = ({
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-black">
      ...
      >
        <PhoneFrameOverlayContext.Provider value={overlay}>
          {/* Background */}
          ...
          <main
            className={clsx(
              ...
              footer ? (bottomNav ? "pb-[200px]" : "pb-[128px]") : bottomNav ? "pb-[128px]" : "pb-6",
            )}
          >
            {children}
          </main>
          ...
          {footer && (
            <div
              className={clsx(
                ...
                bottomNav ? "bottom-[110px]" : "bottom-12",
              )}
            >
              {footer}
            </div>
          ...
          <ToastViewport />
          <div ref={setOverlay} />
        </PhoneFrameOverlayContext.Provider>
      </div>
    </div>
  );
};
